...
/** êëàññ äëÿ ðàáîòû ñ òðåõäèàãîíàëüíîé ìàòðèöåé **/
template<typename Type>
...
/** Ôóíêöèÿ äëÿ ðåøåíèÿ ìåòîä0ì ïðîãîíêè **/
...
public:
    CubicSpline(const std::vector<xType>& points, const std::vector<yType>& values,
        const Deriv2Type& first,  // çíà÷åíèå äëÿ ëåâîé âòîðîé ïðîèçâîäíîé
        const Deriv2Type& second  // çíà÷åíèå äëÿ ïðàâîé âòîðîé ïðîèçâîäíîé
    ) : points{ points }
    {
