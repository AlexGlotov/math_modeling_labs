...
/** класс дл€ работы с трехдиагональной матрицей **/
template<typename Type>
...
/** ‘ункци€ дл€ решени€ метод0м прогонки **/
...
public:
    CubicSpline(const std::vector<xType>& points, const std::vector<yType>& values,
        const Deriv2Type& first,  // значение дл€ левой второй производной
        const Deriv2Type& second  // значение дл€ правой второй производной
    ) : points{ points }
    {
